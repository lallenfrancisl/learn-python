...
# The class, Pokemon, is provided below and describes a Pokemon and its leveling and
# evolving characteristics. An instance of the class is one pokemon that you create.
...
class Pokemon(object):
    ...
    def update(self, health=5, attack=3, defense=2, evolve=10):
        self.health_boost = health
        self.attack_boost = attack
        self.defense_boost = defense
        self.evolve = evolve
...
# Call it opponent. It should return which type of pokemon the current type is
# weak and strong against, as a tuple.
